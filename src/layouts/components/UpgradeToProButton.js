      ...
      <Fade in={open} timeout={700}>
        ...
        >
          <Paper elevation={9} sx={{ borderRadius: 1, overflow: 'hidden' }}>
            ...
            >
              <img width='100%' alt='BookFast-pro-banner' src='/images/misc/BookFast-pro-banner.png' />
            </a>
            <CardContent>
              <Typography sx={{ mb: 4 }} variant='h6'>
                BookFast - React Admin Template
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
                BookFast Admin is the most developer friendly & highly customizable Admin Dashboard Template based on MUI
                and NextJS.
              </Typography>
              <Typography sx={{ mb: 4 }} variant='body2'>
              ...
              <Button
                ...
                target='_blank'
                variant='contained'
                href='https://demos.themeselection.com/BookFast-mui-react-nextjs-admin-template/landing/'
              >
                Demo
              </Button>
              <Button
