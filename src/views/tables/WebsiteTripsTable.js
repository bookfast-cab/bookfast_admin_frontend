...
const WebsiteTripsTable = ({ items = [], onDelete,totalRecords, totalPages, currentPage, perPage, onPageChange = () => {} }) => {
  ...
  const handleEdit = (id) => {
    router.push(`/websiteForm/edit?id=${id}`);
  };
...
export default WebsiteTripsTable;
