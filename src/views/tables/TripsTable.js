...
const TripsTable = ({ items = [], onDelete,totalRecords, totalPages, currentPage, perPage, onPageChange = () => {} }) => {
          ...
          <TableBody>
            {items.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell>{item.vehicle_no || 'N/A'}</TableCell>
                <TableCell>{item.pickup_address || 'N/A'}</TableCell>
                <TableCell>{item.dropoff_address || 'N/A'}</TableCell>
                <TableCell>{item.pickup_distance || 'N/A'}</TableCell>
                <TableCell>{item.total_distance || 'N/A'}</TableCell>
                <TableCell>{item.total_time || 'N/A'}</TableCell>
                <TableCell>{item.total_fare || 'N/A'}</TableCell>
                <TableCell>
                  <IconButton
