...
import TableBasic from 'src/views/tables/PackageTable';
...
const MUITable = () => {
  ...
  // Fetch App Versions
  const getPackageList = async (page_num) => {
    if (!token) return;
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/admin/package?${queryParams}`,
        {
          method: 'GET',
          headers: {
