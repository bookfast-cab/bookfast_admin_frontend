...
const TourPackageForm = (params) => {
  ...
  const getTourPackage = async (id) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setLoadedContent(result.data.location_covered);
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("location_covered", editorContent);
      ...
      <div style={{ display: "flex", gap: "20px", maxWidth: "1400px", margin: "auto" }}>
        ...
        <div style={{ flex: "2" }}>
          ...
          >
            ...
            <div style={{ maxWidth: "100%", margin: "auto", padding: "15px", border: "1px solid #ccc", borderRadius: "5px", backgroundColor: "#f9f9f9" }}>
              <div style={{ marginBottom: "20px" }}>
